      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {assistanceTypes.map((type, index) => (
            <div
              key={index}
              className="p-4 shadow-md rounded-md flex items-center justify-center transition transform hover:bg-blue-400 hover:scale-105 hover:shadow-xl cursor-pointer"
            >
